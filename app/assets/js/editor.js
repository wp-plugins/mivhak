(function($) {
    ...
    tinymce.PluginManager.add( config.slug, function( editor, url ) {
        ...
        function htmlEditorFormat( content ) 
        {
            ...
            // Improved the formatting in the HTML editor by adding a newline after the closing tags of certain elements
            content = content.replace( /<\/(p|pre|li|ul|ol|tr|td|th|table|thead|tbody|tfoot)>/g, function( match, tag ) {
                return '</'+tag+'>\n';
            });

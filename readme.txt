...
**Mivhak** is a lightweight syntax highlighter for WordPress, based on an improved version of *google's Code Prettifier*.
...
1. Specifiy which tags you would like Mivhak to prettify (CODE, PRE, XHR).
